...
public class Main {
    ...
    public static void main(String[] args) {
        Repo repo = new Repo(new ArrayList<>());
        ...
        Tigre t4 = new Tigre("Cotoco", 18, "Carne", new Date(2017, 1,2));
        ...
        Elefante e2 = new Elefante("Ricardo", 75, "Frutas", new Date(2012, 8,2));
        Elefante e3 = new Elefante("Tromba", 69, "Frutas", new Date(2011, 9,2));
        Elefante e4 = new Elefante("Iriu", 80, "Frutas", new Date(2010, 5,2));
        ...
        zoo.imprimirAnimaisMaisNovos();
        zoo.imprimirAnimaisPrecisamConsulta();
    }
}